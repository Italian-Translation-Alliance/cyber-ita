...
Cyber è basato su [Cairn](https://it.cairnrpg.com) di [Yochai Gal](https://newschoolrevolution.com/).
...
Scegli un nome per il tuo personaggio e il suo [background](http://./background.md), che definisce le conoscenze e le abilità sulla base dell’esperienza di vita del personaggio.

Tira **1d4** e moltiplica per **1000**: è l’ammontare iniziale di crediti del tuo personaggio. Possono essere usati per acquistare l'equipaggiamento iniziale (vedi [Inventario](#bookmark=id.3dy6vkm) e [Economia](#bookmark=id.3as4poj)).
...
Ciascuna delle tre **abilità** viene utilizzata in diverse circostanze. (vedi [Tiri salvezza](#bookmark=id.17dp8vu)).
...
Attacchi contro le formazioni da parte di individui sono [compromessi](#bookmark=id.z337ya) (esclusi i danni da [scoppio](#bookmark=id.1y810tw)).

Attacchi contro gli individui da parte delle formazioni sono [potenziati](#bookmark=id.z337ya) e infliggono danni da [scoppio](#bookmark=id.1y810tw).
